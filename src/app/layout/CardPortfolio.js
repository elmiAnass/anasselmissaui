                ...
                <div className="sm:flex">
                    <div>
                        <p className="text-white  max-w-xl opacity-60 text-md   sm:text-lg leading-8 ">
                            <span className="w-4 h-5 p-2 bg-[#2c2626] text-2xl font-primary ">J</span>  e suis développeur web diplômé à ISTA NTIC SAFI
                            option development digital option Full Stack 2023 . Passionné par la programmation web Full Stack,
                            je m'implique pleinement dans la création d'applications
                            complètes en travaillant à la fois sur le front end et le back end.
                            Mon objectif actuel est de perfectionner mes compétences et d'approfondir
                            mes connaissances dans ce domaine à la recherche d'un nouveau stage stimulant.
                            Je suis déterminé à poursuivre mon développement professionnel et à contribuer
                            de manière significative au développement de projets innovants.
                        </p>
                       
                        <p className="text-[#0aff9d] font-face flex items-center">Mes liens : 
                            
                         </p>
                       <div className="  h-[calc(45px + 3.6rem)] pl-5 ">
