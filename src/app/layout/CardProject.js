...
<div class=" mt-40"id="project">
 <h1 className="Project text-white font-boldout sm:text-5xl text-3xl  mb-16 ml-12 opacity-80 "> Projects <span className="text-[#0aff9d]">.</span> </h1>
